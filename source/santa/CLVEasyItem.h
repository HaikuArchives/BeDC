...
class CLVEasyItem : public CLVListItem
{
	public:
		...
		virtual void SetColumnContent(int column_index, const char *text, bool truncate = false,
			bool right_justify = false);
		void SetColumnContent(int columnIndex, int32 value, bool rightJustify = false)
		{
			BString val;
			val << value;
			SetColumnContent(columnIndex, val.String(), false, rightJustify);
		}
		...
		int32 GetColumnContentValue(int columnIndex)
		{
			return atoi(GetColumnContentText(columnIndex));
		}
