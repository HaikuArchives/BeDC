...
OBJS := DCApp.o DCClientConnection.o DCConnection.o DCDownloadQueue.o DCHuffman.o DCSettings.o DCView.o DCWindow.o main.o
OBJDIR := obj.x86
SRCDIR := source
RSRCS := BeDC.rsrc
...
LIBS := -lbe -lroot -ltracker -ltranslation -ltextencoding
CC := g++ -c -pipe
LD := g++
